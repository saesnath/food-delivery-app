import 'package:food_delivery/src/enums/auth_mode.dart';
  ...
  Future<bool> fetchUserInfos() async {
    ...
    try {
      final http.Response response = await http
          .get("https://foodie-b3ee4-default-rtdb.firebaseio.com/foods.json");
  ...
  Future<bool> addUserInfo(Map<String, dynamic> userInfo) async {
    ...
    try {
      final http.Response response = await http.post(
          "https://foodie-b3ee4-default-rtdb.firebaseio.com/foods.json",
    ...
    try {
      ...
      if (authMode == AuthMode.SignUp) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyA1UKKh3SfGw6wJjmlYY5LGn8iAJRlZIGI",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      } else if (authMode == AuthMode.SignIn) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyA1UKKh3SfGw6wJjmlYY5LGn8iAJRlZIGI",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      }
